...
if ($PSCmdlet.ShouldProcess("$resourcePrefix-VNetGW", 'Create Azure Virtual Network Gateway ')) { 
    write-progress $progressActivity "Creating Azure Virtual Network Gateway $resourcePrefix-VNetGW (note: This step can take 10-20 minutes to complete)" -percentcomplete $((($Script:progressScriptStep / $Script:progressScriptMax) * 100); $Script:progressScriptStep++)
